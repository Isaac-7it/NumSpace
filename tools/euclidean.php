        ...
        <div class="">
            <div class="flex flex-wrap justify-between mb-4">
                <div class="flex justify-between items-center flex-1 mb-2 gap-2.5">
                    ...
                    <input type="number" id="number1" name="number1" class="border-gray border-[1.6px] flex-1 rounded-md p-1">
                </div>    
            ...
            <button type="submit" class="bg-[#4F39F6] text-white w-full rounded-lg p-2">Find q and r</button>
        </div>
    </form>
    </div>
</main>